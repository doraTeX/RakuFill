...
- **Dashboard**: manage saved URLs and snapshots, rename, duplicate, delete, reorder, edit JSON directly (validated in real time as you type, with line/column-level error messages shown in red), assign display names to URLs, and filter by URL, display name, or snapshot name.
